...
DATABLOCK_STATUS execute(cosmosis::DataBlock * block, void * config)
{
    ...
    try {
        ...
        transport::twopf_task<double> tk2_test{"gelaton.twopf_test", ics, times, k_test};
...
//        }
        ...
        tk2 = std::make_unique< transport::twopf_task<double> > ("gelaton.twopf", ics, times_sample, ks);
        ...
        tk3e = std::make_unique< transport::threepf_alphabeta_task<double> > ("gelaton.threepf-equilateral", ics,
